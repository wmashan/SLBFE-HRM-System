...
namespace SLBFE.HRM.API.Migrations
{
    ...
    [Migration("20260127065333_AddJwtAuthenticationSupport")]
    partial class AddJwtAuthenticationSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SLBFE.HRM.API.Core.Entities.SystemSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SLBFE.HRM.API.Core.Entities.UserRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SLBFE.HRM.API.Core.Entities.UserRefreshToken", b =>
                {
                    b.HasOne("SLBFE.HRM.API.Core.Entities.User", "User")
                        .WithMany()
