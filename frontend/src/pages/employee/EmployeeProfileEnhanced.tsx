    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Comprehensive view of your professional information</p>
        </div>
        {!isEditing ? (
          <button
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={`LKR ${formData.basicSalary.toLocaleString()}`}
                      disabled
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-100 text-gray-600"
                    />
                  </div>
                    ...
                    <div key={index} className="bg-gray-50 p-4 rounded-lg">
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-900">{qualification.degree}</p>
                        </div>
                        <div>
              ...
              <div className="p-6">
                ...
                <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-sm text-yellow-700">
                    <strong>Security Note:</strong> Banking information is securely encrypted and only accessible to authorized HR personnel for payroll processing.
                  </p>
                </div>
              </div>
            )}
      ...
      {isEditing && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-700">
            <strong>Edit Mode:</strong> You can modify personal information, contact details, emergency contact, and banking information. 
            Employment-related fields are read-only and can only be updated by HR personnel. Changes will be saved to your profile once you click "Save Changes".
          </p>
        </div>
      )}
    </div>
