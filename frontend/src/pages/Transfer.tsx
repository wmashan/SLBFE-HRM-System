...
const Transfer: React.FC = () => {
  ...
  const sampleTransferRequests: TransferRequest[] = [
    ...
    },
    {
      ...
      currentPosition: 'MM 1-1, Grade II',
      ...
      transferType: 'Promotion',
      reason: 'Personal relocation due to family circumstances and career growth',
      status: 'Approved',
      ...
      priority: 'High',
      impactAssessment: 'No impact on productivity, promotion with location change',
    ...
    },
    {
      ...
      currentPosition: 'JM 1-2',
      currentDepartment: 'Marketing',
      currentBranch: 'Regional Office',
      requestedPosition: 'MA 1-2',
      requestedDepartment: 'Placement Services',
      requestedBranch: 'Regional Office',
      transferType: 'Department',
      reason: 'Interest in placement services and cross-functional experience',
      status: 'Rejected',
      requestDate: '2024-01-05',
      proposedDate: '2024-02-20',
      approvedBy: 'Department Head',
      approvedDate: '2024-01-18',
      rejectionReason: 'Current project commitments require completion, insufficient placement services experience',
      priority: 'Low',
    ...
    },
    {
      ...
      currentPosition: 'HM 1-1',
      currentDepartment: 'Operations',
      currentBranch: 'Head Office',
      requestedPosition: 'HM 1-3',
      requestedDepartment: 'Operations',
      requestedBranch: 'Head Office',
      transferType: 'Promotion',
      reason: 'Ready for higher management responsibilities and strategic oversight',
      status: 'Completed',
    ...
    },
    {
      ...
      currentPosition: 'PL-1',
      currentDepartment: 'Customer Service',
      currentBranch: 'Branch A',
      requestedPosition: 'PL-3',
      requestedDepartment: 'Placement Services',
      requestedBranch: 'Branch D',
      transferType: 'Promotion',
      reason: 'Career advancement and relocation for family reasons',
      status: 'Pending',
      requestDate: '2024-01-25',
      proposedDate: '2024-03-15',
      priority: 'High',
      impactAssessment: 'Experienced employee, valuable retention with promotion',
      requiresTraining: true,
      budgetImpact: 3500,
      managerApproval: true,
      hrApproval: false,
    ...
    },
    {
      ...
      currentPosition: 'MM 1-1, Grade I',
      currentDepartment: 'Quality Assurance',
      currentBranch: 'Head Office',
      requestedPosition: 'HM 1-1',
    ...
    },
    {
      ...
      currentPosition: 'MA 1-2',
      currentDepartment: 'Security',
      currentBranch: 'Regional Office',
      requestedPosition: 'MA 2-2',
      requestedDepartment: 'Security',
      requestedBranch: 'Head Office',
      transferType: 'Promotion',
      reason: 'Seeking higher grade position and head office experience',
      status: 'Approved',
      ...
      priority: 'Medium',
      impactAssessment: 'Excellent security record, ready for advancement',
      requiresTraining: true,
      budgetImpact: 6000,
      managerApproval: true,
      hrApproval: true,
  ...
  const sampleEmployees = [
    ...
    },
    {
      ...
      employeeNumber: 'IT001',
      name: 'Michael Chen',
      position: 'MM 1-1, Grade II',
      department: 'IT',
      branch: 'Head Office',
      grade: 'MM 1-1, Grade II',
    ...
    },
    {
      ...
      employeeNumber: 'QA001',
      name: 'Amanda Taylor',
      position: 'MM 1-1, Grade I',
      department: 'Quality Assurance',
      branch: 'Head Office',
      grade: 'MM 1-1, Grade I',
    ...
    },
    {
      ...
      branch: 'Head Office',
      grade: 'HM 2-3',
      email: 'priya.perera@slbfe.com',
      phone: '+94 11 234 5686'
    },
    {
      id: 'EMP010',
      employeeNumber: 'TR001',
      name: 'Kasun Silva',
      position: 'HM 2-1',
      department: 'Training',
      branch: 'Regional Office',
      grade: 'HM 2-1',
      email: 'kasun.silva@slbfe.com',
      phone: '+94 11 234 5687'
    },
    {
      id: 'EMP011',
      employeeNumber: 'PL001',
      name: 'Nilmini Fernando',
      position: 'PL-3',
      department: 'Placement Services',
      branch: 'Branch C',
      grade: 'PL-3',
      email: 'nilmini.fernando@slbfe.com',
    ...
    },
    {
      ...
      branch: 'Head Office',
      grade: 'HM 1-3',
      email: 'chamara.wickramasinghe@slbfe.com',
      phone: '+94 11 234 5689'
    }
  ];

  // SLBFE Grade/Position options
  const gradeOptions = [
    'HM 2-3',
    'HM 2-1',
    'HM 1-3',
